...
public abstract class MvpLinearLayout<V extends MvpView, P extends MvpPresenter<V>>
  ...
  /**
   * Get the com.hannesdorfmann.mosby3.mvp delegate. This is internally used for creating presenter, attaching and detaching
   * view from presenter etc.
   *
   * <p><b>Please note that only one instance of com.hannesdorfmann.mosby3.mvp delegate should be used per android.view.View
   * instance</b>.
   * </p>
   *
   * <p>
