...
import com.boco.app.core.network.observer.DisposablePool;
 ...
 * @since 1.0.0
 */
public class MvpBasePresenter<V extends MvpView> implements MvpPresenter<V>,LifecycleOwner {

  //使用Lifecycle监听Fragment生命周期的变化
  private final LifecycleRegistry mLifecycleRegistry;

  public MvpBasePresenter(){
    //初始化LifecycleRegistry
    mLifecycleRegistry = new LifecycleRegistry(this);
    mLifecycleRegistry.addObserver(DisposablePool.INSTANCE);
