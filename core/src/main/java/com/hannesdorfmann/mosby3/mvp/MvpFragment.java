...
public abstract class MvpFragment<V extends MvpView, P extends MvpPresenter<V>> extends Fragment
  ...
  /**
   * Gets the com.hannesdorfmann.mosby3.mvp delegate. This is internally used for creating presenter, attaching and
   * detaching view from presenter.
   *
   * <p>
   * <b>Please note that only one instance of com.hannesdorfmann.mosby3.mvp delegate should be used per fragment instance</b>.
   * </p>
   *
   * <p>
